...
/*   ft_print_memory.c                                  :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lerodrig <lerodrig@student.42barcelona.co  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/16 22:36:45 by lerodrig          #+#    #+#             */
/*   Updated: 2021/11/17 17:45:25 by lerodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	this recursive function fills "buffer" with a number from 0 to 15
 *
 * */
...
// print a '.' instead of non-printable characters
